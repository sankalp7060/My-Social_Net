...
import { MdOutlineExplore, MdOutlineNotifications, MdFavoriteBorder } from "react-icons/md";
...
const LeftBar = () => {
  ...
  return (
    <div className="w-[20%] p-3 sticky top-0 h-[100vh] overflow-y-auto">
      ...
      <nav>
        <Link to="/" className="flex items-center my-2 p-3 hover:bg-[#5CC7D8] rounded-full cursor-pointer">
        ...
        <Link to={`/profile/${user?._id}`} className="flex items-center my-2 p-3 hover:bg-[#5CC7D8] rounded-full cursor-pointer">
        ...
        <div onClick={logoutHandler} className="flex items-center my-2 p-3 hover:bg-[#5CC7D8] rounded-full cursor-pointer">
